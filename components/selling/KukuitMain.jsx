...
const KukuitMain = () => {
    ...
    const handleCloseModal = () => { setModal(false); router.push('/') }
                    ...
                    {submit ? (
                        <>
                            ...
                            <div className='flex flex-col sm:flex-row sm:justify-end gap-4 my-8 sm:my-[36px]'>
                                ...
                                <Link href={'/'}>
                                    <button className="w-full sm:w-auto px-6 py-3 sm:py-4 rounded-[22px] border border-[#e4086f] text-[#e4086f] text-lg sm:text-xl font-bold font-karla">Cancel</button></Link>
                            </div>
                        </>
                    ) : (
                        <>
