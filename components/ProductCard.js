...
const ProductCard = (productDetails) => {
  ...
  const [showExpandedDateSelection, setShowExpandedDateSelection] =
    useState(false);
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <div className="flex space-x-2">
            ...
            <span
              ...
              style={{ backgroundColor: "#E6E6E6" }}
            >
             {product?.category?.parentCategory || "N/A"}
            </span>
          </div>
          ...
          {/* <p className="text-sm text-gray-600">
            Offers Remaining:{" "}
            {remainingOffers !== undefined ? remainingOffers : "Loading..."}
          </p> */}
          ...
          >
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  href={`/user_profile/${product?.seller?._id}`}
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full max-w-sm sm:max-w-md">
                <p className="text-red-600 font-semibold text-center text-sm sm:text-base">
                  You have reached the maximum limit of 3 offers for this
                  product.
                </p>
                <button
