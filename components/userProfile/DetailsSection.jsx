      ...
      <div className="flex">
        <div className="flex w-full justify-between">
          ...
          <div className="flex items-center justify-center gap-5 relative font-karla font-bold w-[300px]">
            <div className="flex gap-2 cursor-pointer" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
              <Image unoptimized width={30} height={16} src="/sort.svg" className="" alt="" />
              <p>Sort by</p>
            </div>
            <div className="w-5 rotate-90 h-[1px] bg-gray-400"></div>
            <IoPencil className="text-2xl cursor-pointer" onClick={() => setIsOpen(true)} />
            <AddModal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Add Review" />
