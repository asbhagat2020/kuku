                    ...
                    <div className='pt-[126px]'>
                        ...
                        <div className='flex pt-[30px]  gap-[20px]'>
                            <div className="relative">
                                ...
                                <Image className="absolute top-6 right-3" width={16} height={14} src='/drop_down.svg' alt="" />
                            </div>
                            ...
                            <button className='bg-[#fde504] px-[18px] py-[16px] rounded-lg font-karla font-bold'>Export</button>
                        </div>
                        <div className="max-w-[1300px] h-[550px] bg-white rounded-[32.40px] mt-[60px] p-[18px]">
                            <div className='pl-[109px] flex gap-3'>
                                ...
                                <p className="text-[#232323] text-5xl font-bold font-karla leading-[48px]">20,321</p></div>
                                <div className="flex items-end gap-1">
                                    <Image width={20} height={20}  src={'/green_up.svg'} alt=""/>
                                    <p className="text-green-500 text-xl mb-[-5px] font-karla">20%</p>
                                </div>
                            </div>
                            <Chart />
                        </div>
...
export default function DetailsSection() {
    ...
    const sellingData = [
        { id: 1, productImg: ["/card_image2.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
        { id: 2, productImg: ["/card_image1.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
        { id: 3, productImg: ["/card_image3.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
        { id: 4, productImg: ["/card_image2.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
        { id: 5, productImg: ["/card_image1.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
        { id: 6, productImg: ["/card_image3.png", "/card_image2.png", "/card_image3.png"], title: "Dress", price: "AED 120.00", link: "/product" },
