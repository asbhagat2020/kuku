...
const ProfileSection = () => {
    ...
    <div className='flex min-h-fit flex-col items-center p-4 md:p-6'>
        <h2 className="text-[#070707] text-[22.91px] font-bold font-karla leading-7 pb-[20px] md:pb-[57px]">Edit Profile</h2>
        ...
        <form onSubmit={handleSubmit} className="mt-4 w-full max-w-xs md:max-w-md">
            <div>
                <input
                    type="text"
                    name="fullName"
            ...
            <div className="mt-4">
                <textarea rows={2} className="border rounded-[13px] w-full p-2 bg-[#F7F7F7] resize-none" placeholder="Address" name="address"
                    value={formData.address} onChange={handleInputChange} />
                {formErrors.address && <p className="text-red-500 text-sm">{formErrors.address}</p>}
            </div>
            <div className="mt-4 flex justify-center w-full">
                <button type="submit" className="bg-yellow-500 text-white rounded-[13px] px-4 py-2 w-full" >Save Details</button>
            </div>
        </form>
    </div>
</Modal>
