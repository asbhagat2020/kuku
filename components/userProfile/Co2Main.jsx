...
//   const userId = useSelector((store) => store.auth.user?._id); // Fetch _id from user object
//   const [userName, setUserName] = useState("");
//   const [co2Saved, setCo2Saved] = useState(0); // Dynamic CO2 saved
...
//       setCo2Saved(0); // Default to 0 on error
//     } finally {
//       setLoading(false);
//     }
//   };
...
//   const maxCo2Limit = 100; // Define a max limit for percentage calculation
...
//                 {/* CO2 Text Container */}
//                 <div className="relative inline-flex flex-col items-center -mt-4 sm:-mt-6 md:-mt-8 lg:-mt-12">
//                   <div className="flex items-baseline">
//                     <span className="font-karla font-bold text-[15px] sm:text-[30px] md:text-[72px] lg:text-[94px] leading-none text-[#FBE300]">
//                       CO
//                     </span>
...
const Co2Main = () => {
  ...
  const [loadMoreState, setLoadMoreState] = useState('initial'); // 'initial', 'currentMonth', 'lastMonth', 'allLoaded'
