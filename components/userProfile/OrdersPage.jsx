  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 p-8">
      ...
      <div className="flex-1 mt-[70px]">
        ...
        <div className="w-full h-[50vh] flex justify-center items-center mt-12 pt-8 border-t border-gray-200">
          <div className="text-center">
            <h2 className="font-luckiest text-4xl mb-4">Continue shopping to see more orders here :)</h2>
            <Link
              className="text-pink-400 font-karla text-xl underline hover:text-pink-500 transition-colors"
              href={"/selling-page"}
            >
              Continue purchase
            </Link>
