...
const Popup = ({ isOpen, onClose }) => {
  ...
  return (
    isOpen && (
      ...
      >
        <div 
          className="max-h-[90vh] px-4 py-[22px] bg-white rounded-[10px] flex-col justify-start items-center gap-4 inline-flex overflow-y-auto scrollbar-hide"
          style={{
            scrollbarWidth: 'none',
          ...
          <div className="w-[328px] h-[181px] relative rounded-xl border border-[#e0e0e0] flex flex-col p-4">
            ...
            <div className="my-1 text-center">
              <Link
                href="/ku-kit-t&c"
                target="_blank"
                className="text-xs text-[#007bff] underline"
              >
                Kukit policy
              </Link>
            </div>
