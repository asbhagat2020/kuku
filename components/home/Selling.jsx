        ...
        <div className="min-h-[760px] max-w-[1550px] mx-auto relative bg-white pt-[113px]">
            ...
            <div className="h-[70px] w-full justify-between items-center inline-flex px-[20px] lg:px-[73px] ">
                ...
                <Link href="/selling-page">
                    <div className="h-[70px] px-5 lg:px-12 py-[15px] rounded-[22px] border-2 border-[#e4086f] justify-start items-center gap-[11px] flex cursor-pointer">
                        <p className="text-[#e4086f] lg:text-xl font-bold font-karla text-center uppercase leading-snug">
                            View all
                        </p>
                    </div>
                </Link>
