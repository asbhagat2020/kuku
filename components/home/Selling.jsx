    ...
    return (
        <div className="min-h-[760px] max-w-[1550px] mx-auto relative bg-white pt-[113px]">
            ...
            <div className="w-[1440px] h-[70px] justify-between items-center inline-flex px-[73px] ">
                ...
                <div className="w-fit h-[70px] px-12 py-[15px] rounded-[22px] border-2 border-[#e4086f] justify-start items-center gap-[11px] flex">
                    <p className="text-[#e4086f] text-xl font-bold font-karla uppercase leading-snug">View all</p>
                </div>
            </div>
