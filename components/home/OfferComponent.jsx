...
//       // Update parent badge count - FIXED: Only count pending offers and unread notifications
...
//       // FIXED: Update badge count correctly
...
//         // Calculate pending offers once
//         const pendingOffers = offers.filter(offer => offer.status === "Pending");
        
//         if (!notification?.read) {
//           // If notification was unread, decrease the unread count
//           const newUnreadCount = Math.max(0, unreadNotificationCount - 1);
//           setUnreadNotificationCount(newUnreadCount);
//           setOfferCount(pendingOffers.length + newUnreadCount);
//         } else {
//           // If notification was already read, unread count stays the same
//           setOfferCount(pendingOffers.length + unreadNotificationCount);
//         }
...
//         } else if (status === 403) {
//           toast.error("Not authorized to delete this notification");
//         } else if (status === 400) {
...
//   // Updated function to handle both accept and reject using single API
...
//         setCurrentOffer(null);
//         setIsChecked(false);
//         fetchData(); // This will recalculate the badge count
...
//   // Wrapper functions for accept and reject
...
//   // FIXED: Calculate pending offers for display
//   const pendingOffers = offers.filter(offer => offer.status === "Pending");
...
//         >
//           Offers
//           {/* FIXED: Show only pending offers count */}
...
//                   <p className="text-sm text-gray-500">Your offer is waiting for the seller's response</p>
//                 </div>
//               ) : (
//                 <>
...
//                 {id === currentOffer.buyer?._id && (
//                   <p className="text-sm text-gray-500">Proceed to payment to complete your purchase</p>
//                 )}
//               </div>
//             ) : (
//               <div className="text-center">
