    ...
    return (
        ...
        >
            <div className='flex flex-col items-center px-[20px]'>
                ...
                <p className="lg:w-[574px] h-[34px] text-center text-[#515151] text-base font-normal font-luckiest leading-[17.60px] mt-[9px]">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
            </div>
