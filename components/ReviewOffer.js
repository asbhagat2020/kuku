          ...
          {/* <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-[#ededed]">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-start text-black text-sm sm:text-base md:text-[18px] lg:text-xl font-bold font-karla break-words">
                  AMIRI | Men Oversize T-shirt
                </h2>
                <p className="text-start text-[#b4b4b4] font-karla text-xs sm:text-sm md:text-base lg:text-lg mt-1 md:mt-2 break-words">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mt-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-[37px] h-[37px] border border-[#e4086f] flex items-center justify-center">
                      <span className="text-[#e4086f] text-sm md:text-[16px] font-karla">
                        OS
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-[#383838] text-sm md:text-[16px] font-karla font-bold">
                      CONDITION:
                    </span>
                    <span className="text-[#515151] text-sm md:text-[16px] font-karla font-bold">
                      GOOD
                    </span>
                  </div>
                </div>
