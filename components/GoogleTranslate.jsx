  ...
  const handleLanguageChange = (langCode, googleCode) => {
    ...
    setTimeout(() => {
      if (googleCode === 'en') {
        ...
        // Remove ALL possible Google Translate cookies with domain
        ...
        // Clear all Google-related storage
        try {
        ...
        // Reset Google Translate select if exists
        const selectElement = document.querySelector('.goog-te-combo');
        if (selectElement) {
          selectElement.value = '';
