...
export default function Account() {
  ...
  const validatePhoneNumber = (phoneNumber) => {
    ...
    if (!phoneRegexUAE.test(phoneNumber)) {
      return "Please enter a valid 9-digit UAE number starting with 5 (e.g., 567894123)";
    }
    return null;
  };
      ...
      <div className="w-1/2 flex flex-col justify-center items-center px-[150px] py-2">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          <div className="mb-4">
            ...
            <input
              type="tel"
              placeholder="Enter your UAE phone number (e.g., 567894123)"
              value={phone}
            ...
            <p className="text-gray-500 text-xs mt-1">
              Enter a 9-digit UAE phone number starting with 5 (e.g., 567894123).
            </p>
          </div>
